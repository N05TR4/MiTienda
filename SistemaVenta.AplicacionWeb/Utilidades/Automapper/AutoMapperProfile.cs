    ...
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            ...
            CreateMap<VMVenta, Venta>()               
                .ForMember(destino =>
                            destino.SubTotal,
                            opt => opt.MapFrom(origen => Convert.ToDecimal(origen.SubTotal.Value, new CultureInfo("es-DO")))
                 )
                .ForMember(destino =>
                            destino.ImpuestoTotal,
                            opt => opt.MapFrom(origen => Convert.ToDecimal(origen.ImpuestoTotal.Value, new CultureInfo("es-DO")))
                 )
                .ForMember(destino =>
                            destino.Total,
                            opt => opt.MapFrom(origen => Convert.ToDecimal(origen.Total.Value, new CultureInfo("es-DO")))
            ...
            CreateMap<DetalleVenta, VMReorteVenta>()
                .ForMember(destino =>
                            destino.FechaRegistro,
