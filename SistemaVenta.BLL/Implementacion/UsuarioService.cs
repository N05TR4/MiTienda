...
namespace SistemaVenta.BLL.Implementacion
{
    public class UsuarioService : IUsuarioService
    {
        ...
        private readonly IUtilidadesServices _utilidadesService;
        private readonly ICorreoService _correoService;

        public UsuarioService(
            IGenericRepository<Usuario> repositorio,
            iFireBaseService fireBaseService,
            IUtilidadesServices utilidadesService,
        ...
        public async Task<bool> Eliminar(int IdUsuario)
        {
            try
            {
                ...
                if (respuesta)
                    await _fireBaseService.EliminarStorage("carperta_usuario", nombreFoto);
        ...
        public async Task<bool> CambiarClave(int IdUsuario, string ClaveActual, string ClaveNueva)
        {
            try
            {
                ...
                bool respueta = await _repositorio.Editar(usuario_encontrado);
                return respueta;
